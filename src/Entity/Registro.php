...
class Registro
{
    ...
    public function getVegecomentario(): ?string
    {
        return $this->vegecomentario;
    }

    public function setVegecomentario(string $vegecomentario): self
    {
        $this->vegecomentario = $vegecomentario;
